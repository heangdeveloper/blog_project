    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="{{ Request::is('admin/user*') ? 'nav-item menu-open' : 'nav-item' }}">
                    <a href="#" class="{{ Request::is('admin/user*') ? 'nav-link active' : 'nav-link' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.user.create') }}" class="{{ Request::is('admin/user/create') ? 'nav-link active' : 'nav-link' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add New</p>
                            </a>
                        </li>
