            ...
            <div class="row">
                <div class="col-12 col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" autocomplete="off" id="add_tag">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-success btn-sm rounded-0">Add New Tag</button>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-head-fixed text-nowrap" id="tag_table">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
...
@section('script')
    <script>
        ...
        // update tag
        $(function() {
            $('#edit_tag form').on('submit', function(e) {
                if (!e.isDefaultPrevented()) {
                    var id = $('#edit_id').val();
                    $.ajax({
                        url: "{{ url('admin/tag') }}" + '/' + id,
                        type: "POST",
                        data: $('#edit_tag form').serialize(),
                        success: function(data) {
                            console.log(data)
                            $('#edit_tag').modal('hide');
                            table.ajax.reload();
